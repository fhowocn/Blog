...
export const siteConfig: SiteConfig = {
	...
	siteURL: "https://blog.fhowo.top/", // 请替换为你的站点URL，以斜杠结尾
	...
	bilibili: {
		vmid: "3546713098816154", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
...
export const commentConfig: CommentConfig = {
	...
	giscus: {
		...
		repoId: "R_kgDOR8yP6w",
		category: "General",
		categoryId: "DIC_kwDOR8yP684C6Xgo",
		mapping: "pathname",
		strict: "0",
		reactionsEnabled: "1",
		emitMetadata: "0",
